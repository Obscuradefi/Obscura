        ...
        pages: [
            {
                ...
                content: [
                    ...
                    { type: 'list', items: [
                        '**Privacy Layer**: Shield and unshield tokens. Your balances are encrypted on-chain and only you control visibility.',
            ...
            },
            {
                ...
                content: [
                    ...
                    { type: 'table', headers: ['Trade Size (USD)', 'Route', 'Why'], rows: [
                        ...
                        ['$100,000 to $500,000', 'HYBRID', 'Compare AMM and RFQ to find best price'],
                    ...
                    { type: 'steps', steps: [
                        ...
                        { title: 'Market makers respond', description: '2 to 3 market makers submit competing quotes within seconds. Each quote includes an amount, rate, fee (0.01 to 0.05%), and expiry countdown (15 to 30s).' },
                        ...
                        { title: 'Atomic execution', description: 'The swap settles on-chain in a single transaction with no MEV and no frontrunning. RFQ offers 1 to 3% better pricing than AMM for large trades.' },
                    ]},
                    ...
                    { type: 'table', headers: ['Feature', 'AMM', 'RFQ'], rows: [
                        ...
                        ['Fee', '0.3% (0.05% stablecoins)', '0.01 to 0.05%'],
        ...
        pages: [
            ...
            },
            {
                ...
                content: [
                    ...
                    { type: 'table', headers: ['Mode', 'Description', 'Best For'], rows: [
                        ...
                        ['Hybrid', 'Smart router selects the best path', 'Default with optimal price guarantee'],
                    ]},
                ]
            },
            {
            ...
            },
            {
                ...
                content: [
                    ...
                    { type: 'paragraph', content: 'Liquidity providers (LPs) deposit tokens into a pool, enabling others to swap between those tokens. LPs earn trading fees proportional to their share of the pool.' },
                    ...
                    { type: 'steps', steps: [
                        ...
                        { title: 'Enter Amount', description: 'Enter the amount of the token you want to deposit.' },
                        { title: 'Approve Tokens', description: 'Approve the token if you haven\'t already.' },
            ...
            },
            {
                ...
                content: [
                    ...
                    { type: 'list', items: [
                        ...
                        '**Asset Table**: Detailed breakdown of each token with balance, price, 24h change, and total value.',
        ...
        pages: [
            {
                ...
                content: [
                    ...
                    { type: 'paragraph', content: 'The SimpleAMM contract is the primary trading mechanism in Obscura. It is deployed at 0x944b6cB6d8621603B4a094955123dbD96e289bA2 on Base Sepolia. It uses the constant product formula with ReentrancyGuard and Ownable from OpenZeppelin.' },
            ...
            },
            {
                ...
                content: [
                    ...
                    { type: 'list', items: [
                        ...
                        '**Lower Fees**: RFQ fees range from 0.01 to 0.05%, compared to AMM\'s 0.3%.',
                        '**MEV Protection**: Atomic execution prevents frontrunning and sandwich attacks.',
                        '**Competitive Pricing**: 2 to 3 market makers compete for each order, ensuring fair pricing.',
                        '**Time-limited Quotes**: Quotes expire in 15 to 30 seconds, ensuring current market pricing.',
                    ]},
                ]
            },
            {
            ...
            },
            {
                ...
                content: [
                    ...
                    { type: 'callout', variant: 'info', title: 'Rialo Integration', content: 'On Rialo mainnet, shielded assets will be handled by a confidential RFC (Request for Computation) interacting with the REX layer. This provides real cryptographic privacy guarantees at the chain level.' },
                ]
            },
            {
                id: 'smart-contracts',
        ...
        pages: [
            ...
            },
            {
                ...
                content: [
                    ...
                    { type: 'code', language: 'bash', content: 'npm install viem wagmi @tanstack/react-query @rainbow-me/rainbowkit' },
            ...
            },
            {
                ...
                content: [
                    ...
                    { type: 'table', headers: ['Color', 'Hex', 'Usage'], rows: [
                        ['Forest Green', '#3D9E4E', 'Primary accent, CTAs, links'],
                        ['Neon Purple', '#9D4EDD', 'Secondary accent, privacy features'],
                        ['Void Black', '#07070A', 'Background'],
